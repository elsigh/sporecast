 ...
 * @type {string}
 */
sc.models.SERVER_PROD =
  window.location.hostname.indexOf("appspot") !== -1
...
/** @type {Array.<number>} */
sc.models.WeatherPrefsYears = [2017, 2016, 2015, 2014, 2013];
...
sc.models.WeatherData.prototype.initialize = function(opt_data, opt_options) {
  ...
  this.prefs = new sc.models.WeatherPrefs(sc.models.WeatherPrefs.getFromUrl());
